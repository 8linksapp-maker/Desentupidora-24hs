...
var ReactQuill = class extends import_react.default.Component {
  ...
  */
  renderEditingArea() {
    ...
    return preserveWhitespace ? (0, import_jsx_runtime.jsx)("pre", { ref: this.editingAreaRef }, generation) : (0, import_jsx_runtime.jsx)("div", { ref: this.editingAreaRef }, generation);
  }
  render() {
  ...
  onEditorChangeSelection(nextSelection, source, editor) {
    ...
    if (isEqual_default(nextSelection, currentSelection)) return;
